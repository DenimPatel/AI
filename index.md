...
<section id="robotics" class="section" style="padding-bottom: 40px;">
  ...
  <div class="card-grid card-grid--tight" style="margin-bottom: 24px;">
    ...
    <div class="card"><div class="card-kicker">Interactive · 15 parts</div><div class="card-title">LLM training</div><p class="card-body">Tokens and embeddings, the transformer block, pretraining data and the training loop, scaling laws, fine-tuning and LoRA, RLHF/DPO, reasoning &amp; RLVR, long-context extension, tool use &amp; agents, post-training at scale, evaluation, inference, and guardrails — built step by step using the fully-open OLMo model family as a running example.</p></div>
  </div>
  ...
  <a href="{{ '/llm-training-index.html' | relative_url }}" class="btn btn-ghost">Try the LLM training guide →</a>
</section>
