...
volumes: 22 parts of linear algebra, two 14-part volumes of calculus, and a 32-part guide
to statistics that runs from a single sample to Kalman filters and causal inference — plus
a set of field notes on ROS and robot navigation.
