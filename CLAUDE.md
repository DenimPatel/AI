...
rules are byte-identical across all 18 MVG files. Extracting them to a shared stylesheet
...
**This is additive only.** The 24 existing multi-view-geometry and nonlinear-optimization
