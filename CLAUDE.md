...
rules are byte-identical across all 16 MVG files. Extracting them to a shared stylesheet
...
**This is additive only.** The 22 existing multi-view-geometry and nonlinear-optimization
